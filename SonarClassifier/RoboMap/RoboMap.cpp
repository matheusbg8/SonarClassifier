...
//        polylines(screen, ppt, npts, 1,true, color,18);
        polylines(screen, ppt, npts, 1,true, color,4);

//        circle(screen,UTM2Img(sonar.p),50,color,-1);
        circle(screen,UTM2Img(sonar.p),12,color,-1);
