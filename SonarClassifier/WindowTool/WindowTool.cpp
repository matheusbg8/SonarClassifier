...
//    Mat left8b;
//    leftImg.convertTo(left8b,CV_8UC1);
//    imshow("LeftImgBeforeCorrection",left8b);
//    imwrite("LeftImgBeforeCorrection8b.png",left8b);
//    imwrite("LeftImgBeforeCorrection16b.png",leftImg);
...
//    leftImg.convertTo(left8b,CV_8UC1);
//    imshow("LeftImgAfterCorrection",left8b);
//    imwrite("LeftImgAfterCorrection8b.png",left8b);
//    imwrite("LeftImgAfterCorrection16b.png",leftImg);

//    isonificationPattern.convertTo(left8b,CV_8UC1);
//    imwrite("InsonificationPatternTrucated.png",left8b);

//    Drawing::imShow16BitsTrucated("LeftImgAfterCorrection",leftImg);
